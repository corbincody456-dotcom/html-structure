# Part 1: cerate the parent class with shared family traits
class FamilyMember:
...
# Part 4: Override show traits to add the kids own details too
    def show_traits(self):
...
print("Is Kid a subclass of FamilyMembers?", issubclass(Kid, FamilyMember))